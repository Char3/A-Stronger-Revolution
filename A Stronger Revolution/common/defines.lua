...
country = {
    ...
    CONSERVATIVE_INCREASE_AFTER_REFORM = 0.5, -- how many more conservatives in a upper house.
...
pops = {
    ...
    MIL_LACK_EVERYDAY_NEED = 0.01,
    MIL_HAS_EVERYDAY_NEED = -0.4,
    MIL_HAS_LUXURY_NEED = -0.6,
    MIL_NO_LIFE_NEED = 0.8,
    MIL_REQUIRE_REFORM = 0.005,
    MIL_IDEOLOGY = -0.1,
    MIL_RULING_PARTY = -0.1,
    MIL_REFORM_IMPACT = 2,
    MIL_WAR_EXHAUSTION = 0.005,
    MIL_NON_ACCEPTED = 0.01,
    ...
    REDUCTION_AFTER_DEFEAT = 70.0, -- After a rebellion is being defeated in combat, its pop militancy will be divided by this number.
...
graphics =
{
    ...
    CITIES_SIZE_MAX_POPULATION_K = 2000             -- When province population reach 1mln, the city will get it's maximum size.
}
